...
useEffect(() => {
  ...
  if(isLogined){
    ...
    return (
        <div className='mb-12'>
            <Banner title={''} subHeading1={'Home'} subHeading2={'nurses care Details'} />
            <div className='lg:flex lg:flex-row justify-center sm:flex sm:flex-col w-full px-6 md:px-12 mt-12 gap-6 mx-0'>
                    ...
                    <div className='bg-white py-2 px-2'>
                        {nursesData ? (
                            <div className='flex gap-2'>
                                <div>
                                    <Image src={nursesData.images.url} width={100} height={100} alt={nursesData.images.name} className=" w-[100%]  h-[100%]" style={{ objectFit: 'cover' }} />
                                </div>
                                <div className=''>
                                    <div className='flex gap-2 items-center'>
                                        <h2 className='text-lg text-black font-semibold'>{nursesData.name}</h2> {/*added text-black class*/}
                                        <div className='text-green-600'><FaCheckCircle /></div>
                                    </div>
                                    <div>
                                        <h3 className='text-sm text-[#1A3578]'>Education: {nursesData.education} /{nursesData.experience} Years Experience </h3>
                                    </div>
                                    <div>
                                        <h3 className='text-xs text-[#B1B1B1]'>Working at {nursesData.workingAt} Hospital</h3>
                                    </div>
                                    ...
                                    <div className='  w-full mt-2'>
                                        <button className='bg-[#CDF27E] w-full text-black px-6 py-2  rounded-md' >Fee: {nursesData?.fees}/- (per day)</button>
                            ...
                            {/* <div className='flex justify-end mt-4'>
                                <div className='grid grid-cols-1 grid-rows-7 text-xs w-full '>
                                    ...
                                    <div className='grid  grid-cols-3 border border-gray-100'>
                                        ...
                                        <div className={`col-span-2 flex py-2 justify-center ${nursesData?.availability === 'weekend' || 'fullWeek' ? 'bg-[#1A3578] text-white' : 'text-black'} flex-col items-center`}>
                                            <h2>{nursesData?.availability === 'weekdays' || 'fullWeek' ? 'Available' : 'Not available'}</h2>
                                        </div>
                                    </div>
                                    <div className='grid grid-cols-3 border border-gray-100'>
                                        <div className='col-span-1 flex justify-center bg-[#B7B7B7] '>
                                    ...
                                    <div className='grid grid-cols-3 border border-gray-100'>
                                        ...
                                        <div className={`col-span-2 flex py-2 justify-center ${nursesData?.availability === 'weekend' || 'fullWeek' ? 'bg-[#1A3578] text-white' : 'text-black'} flex-col items-center`}>
                                            <h2>{nursesData?.availability === 'weekend' || 'fullWeek' ? 'Available' : 'Not available'}</h2>
                                        </div>
                                    </div>
                                    <div className='grid grid-cols-3 border border-gray-100'>
                                        <div className='col-span-1 flex justify-center bg-[#B7B7B7] '>
                                        ...
                                        <div className={`col-span-2 flex py-2 justify-center ${nursesData?.availability === 'weekend' || 'fullWeek' ? 'bg-[#1A3578] text-white' : 'text-black'} text-white flex-col items-center`}>
                                            <h2>{nursesData?.availability === 'weekend' || 'fullWeek' ? 'Available' : 'Not available'}</h2>
                                        </div>
                                    </div>
                ...
                <div className='lg:w-[55%] sm:w-[100%] bg-white px-6'>
                    ...
                    <div className=' mt-6 md:mt-8'>
                        ...
                        <div className='mb-1 ml-2'>Amount: {Number(nursesData?.fees * diffDays) || nursesData?.fees}</div>
                        <div className='grid grid-cols-2 grid-rows-[80px_80px_80px_80px_120px_80px] ' >
                            ...
                            <div className='flex flex-col row-span-1 px-2'>
                                ...
                                <input onChange={handleFormChange}   name='bookFrom' type='date' placeholder='12-May-2023' className='py-2 px-2 bg-transparent border border-black rounded-md' />

                            </div>
                            <div className='flex flex-col row-span-1 px-2'>
                                <label className=''> To </label>
                                <input onChange={handleFormChange}    name='bookTo' type='date' placeholder='14-May-2023' className='py-2 px-2 bg-transparent border border-black rounded-md' />
                            ...
                            <div className='col-span-2 md:mt-4'>
                                <button className='bg-[#CDF27E] w-full py-2 rounded-lg ' onClick={addData}>Book Now</button>
                            </div>
                        </div>
                    </div>
                </div>
